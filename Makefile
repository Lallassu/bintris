...
android:
	...
	ANDROID_NDK_HOME=$(NDK) /home/nergal/go/src/golang.org/x/mobile/cmd/gomobile/gomobile build -target android -androidapi=23 -o bintris.apk -ldflags="-w" -gcflags="-w -I /home/nergal/Downloads/openal/openal-soft/include/" -x
android_install:
