...
#NDK=/tmp/ndk-nergal/arm-linux-androideabi
...
openal:
	...
	#ANDROID_NDK_HOME=$(NDK) /home/nergal/go/src/golang.org/x/mobile/cmd/gomobile/gomobile init -openal /home/nergal/Downloads/openal/openal-soft/ -v -x
	...
	PATH="/home/nergal/Downloads/cmake-3.22.1-linux-x86_64/bin:$(PATH)" ANDROID_PLATFORM=android-23 ANDROID_HOME=~/Android/Sdk/ ANDROID_NDK_HOME=$(NDK) /home/nergal/go/src/golang.org/x/mobile/cmd/gomobile/gomobile init -openal /home/nergal/Downloads/openal/openal-soft/
...
bind:
	ANDROID_HOME=$(NDK) ANDROID_NDK_HOME=$(NDK) gomobile bind -target android -androidapi=23 -o bintris.apk -ldflags="-w" -gcflags="-w -I /home/nergal/Downloads/openal/openal-soft/include/" 

android_install:
	#ANDROID_NDK_HOME=$(NDK) gomobile install -target android -androidapi=23 -o bintris.apk
	ANDROID_NDK_HOME=$(NDK) /home/nergal/go/src/golang.org/x/mobile/cmd/gomobile/gomobile install -target android -androidapi=23 -o bintris.apk -ldflags="-w" -gcflags="-I /home/nergal/Downloads/openal/openal-soft/include/" -x
linux:
	go build .
