...
func (m *Menu) Init(g *Game) {
	...
	m.how = m.gh.tex.AddText("How to play", 0.16+offsetX, 0.58, 0.6, 0.05, 0.05, EffectNone)
	m.scoreBoard = m.gh.tex.AddText("Scoreboard", 0.20+offsetX, 0.51, 0.6, 0.05, 0.05, EffectNone)
	m.about = m.gh.tex.AddText("about", 0.34+offsetX, 0.44, 0.6, 0.05, 0.05, EffectNone)
	m.quit = m.gh.tex.AddText("quit", 0.37+offsetX, 0.37, 0.6, 0.05, 0.05, EffectNone)
